...
<head>
<meta charset="UTF-8">
<title>e-chambre inscription</title>
          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="/e-chambre1/ajouterUtilisateur.do" method="post">
                ...
                <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <a href="/e-chambre1/seConnecter.do">se connecter</a>
                </div>
