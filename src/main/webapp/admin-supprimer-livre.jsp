...
<table class="table">
  <thead>
    <tr>
      ...
      <th scope="col">modifier la chambre</th>
      <th scope="col">supprimer la chambre</th>
    </tr>
  </thead>
  <tbody>
  <c:forEach items="${chambres }" var="chambre">
    <tr>
      ...
      <td><a href="/e-chambre1/modifier-livre.do?id_chambre=${chambre.id }" type="button" class="btn btn-outline-info">modifier cette chambre</a></td>
      <td><a href="/e-chambre1/supprimerLivre.do?id_chambre=${chambre.id }" type="button" class="btn btn-outline-danger">supprimer cette chambre</a></td>
    </tr>
  </c:forEach>
