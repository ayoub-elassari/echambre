  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/e-chambre1/admin-supprimer-reservation.do">annuler la réservation d'un livre</a>
        </li>
      </ul>
    </div>
  </div>
...
<table class="table">
  ...
  <c:forEach items="${utilisateurs }" var="utilisateur">
    <tr>
      ...
      <td><a href="/e-chambre1/supprimerUtilisateur.do?id_user=${utilisateur.id }" type="button" class="btn btn-outline-danger">supprimer cet utilisateur</a></td>
    </tr>
  </c:forEach>
